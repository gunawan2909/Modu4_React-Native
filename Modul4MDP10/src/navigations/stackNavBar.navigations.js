...
return (
<NavStack.Navigator>
<NavStack.Screen name="Home" component={Pages.HomePages} options={{
headerTitle: 'Home',
tabBarIcon: ({color}) => {
...
/>
<NavStack.Screen name="Profile" component={Pages.ProfilePages} options={{
headerTitle: 'Search', tabBarIcon: ({color}) => {
